...
import { FiMapPin, FiHome, FiCalendar, FiClock, FiCheck, FiUser, FiPhone, FiMail, FiArrowRight, FiPlus, FiInfo, FiStar, FiShield, FiAward, FiZap, FiLoader } from 'react-icons/fi';
...
const GetFreeSurveyPage = () => {
  ...
  const propertyTypes = [
    ...
    { value: 'industrial', label: 'Industrial', icon: '🏭', color: 'red' }
  ];
