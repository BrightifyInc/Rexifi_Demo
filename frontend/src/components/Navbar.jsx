...
//               </li>
//               {/* <li className="max-lg:border-b max-lg:border-gray-300 max-lg:dark:border-gray-700 max-lg:py-3 max-lg:mt-2">
//                 <Link to="/learn" className="hover:text-blue-700 dark:hover:text-blue-400 text-slate-900 dark:text-white block font-medium text-[15px]">
//                   Learn
//                 </Link>
//               </li> */}
//             </ul>
...
//         </p>
//         <button className="px-8 py-3 bg-green-500 text-white rounded-lg font-semibold hover:bg-green-600 transition-colors duration-200">
//           Get Started
//         </button>
//       </div>
//     </div>
