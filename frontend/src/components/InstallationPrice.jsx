...
//   return (
//     <section className="py-14 md:py-28 bg-gray-50 dark:bg-gray-900 overflow-hidden">
...
//             className="mb-3 font-bold text-center text-gray-800 dark:text-white/90 text-3xl md:text-5xl"
//           >
//             Professional Installation Services
//           </motion.h2>
//           <motion.p
//             variants={itemVariants}
//             className="max-w-2xl mx-auto leading-6 text-gray-500 dark:text-gray-400 text-lg"
//           >
...
//                   className={`bg-white dark:bg-gray-800 rounded-3xl p-8 border-2 ${colorMap[currentPlan.color].border} shadow-2xl`}
//                 >
//                   {/* Plan Header */}
...
//                     className={`w-full ${colorMap[currentPlan.color].solid} text-white px-8 py-4 rounded-2xl font-semibold text-lg hover:shadow-2xl transition-all duration-300 flex items-center justify-center gap-3`}
//                   >
...
//                 >
//                   <h4 className="font-semibold text-gray-800 dark:text-white mb-4 text-lg">
...
//               className="relative bg-white dark:bg-gray-800 rounded-3xl max-w-md w-full p-8"
...
//                   className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-gray-800 dark:text-white placeholder-gray-500 focus:outline-none focus:border-blue-500"
//                 />
//                 <input
//                   type="tel"
...
//                   className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-gray-800 dark:text-white placeholder-gray-500 focus:outline-none focus:border-blue-500"
//                 />
//                 <select className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-gray-800 dark:text-white focus:outline-none focus:border-blue-500">
...
//                     type="button"
//                     onClick={() => setShowContactForm(false)}
//                     className="flex-1 px-6 py-3 text-gray-600 dark:text-gray-400 border border-gray-300 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
//                   >
//                     Cancel
//                   </button>
//                   <button
